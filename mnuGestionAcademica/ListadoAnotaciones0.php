<?php
	...
	if (isset($_POST['txtFecha'])){
		$_SESSION['SQL']=$_POST['txtFecha'];
	}
	else{
		$_SESSION['SQL']=date("d-m-Y");
	}
?>
...
var colsOption = [
	...
	{id : "Programa" , header: "Programa" , width :80,readonly:false},
	{id : "Fecha" , header: "Fecha" , width :80,readonly:false},
	{id : "TipoDeberes" , header : "Tipo Deberes",width :100, readonly:false},
	{id : "ControlPreDeberes" , header : "Control Predeberes",width :150, readonly:false},
	{id : "ControlDeberes" , header : "Control Deberes",width :100, readonly:false},
	{id : "ComentariosProf" , header : "Comentarios Profesor",width :200, readonly:false}
];
...
var gridOption={
	...
	resizable : true,
	loadURL : "BD/BDListadoAnotaciones.php",
	container : 'gridbox',
	dataset : dsOption ,
	columns : colsOption,
	toolbarPosition : 'top',
...
<body>
  ...
  <hr />
  <br />
  <form action="ListadoAnotaciones0.php" method="post">
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Teclea apartir de la fecha:</strong>&nbsp;
  <input name="txtFecha" type="text" value="<?php echo $_SESSION['SQL'] ?>" size="10" maxlength="15" />
