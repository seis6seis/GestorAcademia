...
$ft["settings"]["DIR"]               = "./documentos"; // Your default directory. Do NOT include a trailing slash!
$ft["settings"]["LANG"]              = "es"; // Language. Do not change unless you have downloaded language file.
$ft["settings"]["MAXSIZE"]           = 20971520; // Maximum file upload size - in bytes.
...
<body>
  	<?php echo "<b><div align='left'>La ruta actual es:</b>&nbsp;http://www.englishconnection.es/GestorAcademia/mnuDirectores/deberes/".substr(ft_get_dir(),2)."</div>"; ?>
	<?php echo $str;?>
