...
<body>
  ...
  <p><br />
    <?php
		...
		$sql="INSERT INTO historico_pagos (Cod,Fecha_Ge,Matricula,Nombre_Alumno,Periodo,Centro,Pagado,Metalico) ";
		$sql=$sql."VALUES ('".$_GET['Codigo']."','".date('Y-m-d')."','".$_GET['Matricula']."','".$_GET['NombreAlumno']."','".date('m')."','".$_GET['Centro']."','NO','NO')";
