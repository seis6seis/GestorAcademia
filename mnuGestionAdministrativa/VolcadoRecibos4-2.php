...
<body>
  <table width="100%" border="0">
    <tr>
      <td width="111"><img src="../Imagenes/logo_blanco.png" alt="Logo EnglishConnection" width="111" height="49" /></td>
        <td width="88%"><div align="center" class="Titulo"><!-- InstanceBeginEditable name="EditRegion4" --><strong>Adultos Cuatrimestre</strong><!-- InstanceEndEditable --></div></td>
    </tr>
  </table>
  ...
  <?php
	...
	$sql=$sql." SELECT Alumnos.Fecha_Co, Alumnos.Fecha_Ba, Alumnos.Codi, Alumnos.Nombre_Alumno, GruposCuotas.CuotasTrim*".$_POST['cmbRecibo']." AS Cuota, If(Alumnos.Descuento='YES','12345.12','0'),'12345.12','".date('m')."','".$_SESSION['Centro']."'";
	$sql=$sql." FROM GruposCuotas INNER JOIN Alumnos ON GruposCuotas.Grupo=Alumnos.Grupo";
	$sql=$sql." WHERE (Alumnos.Fecha_Ba='0000-00-00' AND (Alumnos.Pago LIKE 'CU_%') AND alumnos.Centro='".$_SESSION['Centro']."')";
