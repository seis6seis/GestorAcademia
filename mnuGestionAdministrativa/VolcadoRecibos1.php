  ...
  <table width="100%" border="0">
    <tr>
      <td width="111"><img src="../Imagenes/logo_blanco.png" alt="Logo EnglishConnection" width="111" height="49" /></td>
        <td width="88%"><div align="center" class="Titulo"><!-- InstanceBeginEditable name="EditRegion4" -->Trimestral y Mensual<!-- InstanceEndEditable --></div></td>
    </tr>
  </table>
  ...
  <?php
	...
	if (!empty($miconexion->$Error)){
		...
		if (!empty($miconexion->$Error)){
			...
			echo "<br /><br /><br />\n";
			echo "<div align=center><b>Han sido realizado el volcado de recibos Trimestral y Mensual.</b><div>\n";
		}
	}
