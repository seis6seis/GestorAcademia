...
<?php
	...
	$miconexion->conectar();
	$sql="UPDATE Movimientos SET idCuenta='".$_POST['cmbIDCuenta']."', idTipo='".$_POST['cmbIDTipo']."', Fecha='".$_POST['txtFecha']."', Descripcion='".$_POST['txtDescripcion']."', Haber='".$Haber."', Debe='".$Debe."' WHERE idMovi='".$_POST['txtCodigo']."'";
